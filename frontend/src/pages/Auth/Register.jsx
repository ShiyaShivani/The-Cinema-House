...
const Register = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-gray-900 overflow-hidden">
      ...
      />
      <div className="relative z-10 bg-gray-800 bg-opacity-75 p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={submitHandler} className="container">
          ...
          <button
            disabled={isLoading}
            type="submit"
            className="bg-teal-500 text-white px-4 py-2 rounded cursor-pointer mt-4 w-full"
          >
